                ...
                {calDays.map((cell, idx) => {
                  ...
                  return (
                    <div key={idx}
                      ...
                      className={`min-h-[60px] md:min-h-[100px] border-b border-r border-toss-gray-50 p-1 ${!cell.current ? "opacity-40" : ""} ${cell.current && isToday(cell.day) ? "bg-blue-50/60 ring-2 ring-toss-blue ring-inset" : ""}`}>
